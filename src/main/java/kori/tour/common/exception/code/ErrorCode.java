...
public enum ErrorCode {
    ...
    HTTP_BAD_REQUEST(HttpStatus.BAD_REQUEST, "Bad Request"),
    HTTP_UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "Unauthorized"),
    HTTP_FORBIDDEN(HttpStatus.FORBIDDEN, "Forbidden"),
